...
const Contact=()=>{
    return(
        ...
        <div id="contact"  className="w-full  bg-black pt-28 pb-20  ">       {/*pt-28 */}
            ...
            <div className="text-center text-gray-400 text-sm sm:text-lg md:text-2xl mt-3"><p>Have a project in mind or want to collaborate? Let's create something <br></br> amazing together.</p></div>
                <div className=" bg-black flex flex-col md:flex-row gap-5 w-full  ">
                     <div className="bg-[#0F0F11] w-full mr-2 md:mr-0 md:w-1/2 h-[24rem] ml-0 md:m-5 pt-10 pl-2 sm:pl-5 md:pl-10 rounded-2xl border border-gray-800" >
                   ...
                   <Link to={"https://www.linkedin.com/in/dibya-majumdar-3879102a2/"} >  <div className="bg-[#22222A] rounded-full w-16 h-16 mb-3 flex justify-center items-center"><Linkedin className="text-white" size={38}/></div></Link>
                     ...
                     <div className="bg-[#0F0F11] w-full md:w-1/2 ml-0 md:m-5 mr-28 h-auto p-10 rounded-2xl border border-gray-800">
                        <div className="mt-2">
