...
const Journey=()=>{
    return(
        ...
        <div  id="journey" className="scroll-mt-28">
         <div className="bg-black text-center flex flex-wrap gap-3 justify-center w-full ">
             ...
             <div className="text-center flex justify-center items-center bg-black text-gray-400 text-sm sm:text-lg md:text-2xl pt-3"><p>A timeline of learning, building, and evolving across web and AI.</p></div>
            ...
            <div className="block lg:hidden  text-white bg-black">
              <div className="w-full flex flex-col gap-5 justify-center items-center">
                 <div className="w-[25rem] flex justify-center mt-2"><AboutMeCard date="2023" heading="Frontend" desc="Started journey with HTML, CSS, JavaScript" position="right" /></div>
                  <div className="relative rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 h-16 w-16  overflow-hidden shadow-[0_0_60px_rgba(59,130,246,0.8)]">     
                    ...
                    <div className="w-[25rem] flex justify-center"> <AboutMeCard date="2023" heading="React & Redux" desc="Learn frontend library React js and Redux" position="left" /></div>
                  ...
                  <div className="w-[25rem] flex justify-center"><AboutMeCard date="2023" heading="Backend" desc="Learn Nodejs,express js,mongodb ,jwt token " position="right" /></div>
                   <div className=" rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 h-16 w-16  overflow-hidden shadow-[0_0_60px_rgba(59,130,246,0.8)]">
                                <div className=" transition-transform duration-100 ease-in-out  ml-3 mt-3 scale-110  hover:scale-110 hover:rotate-[720deg] "><  Server size={40} /></div> 
                                 </div>
                     <div className="w-[25rem] flex justify-center"><AboutMeCard date="2024" heading="Machine Learning" desc="Learn basics, python,diff models ,diff algos " position="left" /></div>
                  ...
                  <div className="w-[25rem] flex justify-center"> <AboutMeCard date="2024" heading="Deep Learning" desc="learn basics,CNN,RCNN adn other dl models" position="right" /></div>
                    <div className=" rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 h-16 w-16 overflow-hidden shadow-[0_0_60px_rgba(59,130,246,0.8)]">
                                <div className=" transition-transform duration-100 ease-in-out  ml-3 mt-3 scale-110   hover:scale-110 hover:rotate-[720deg] ">< Eye size={40} /></div> 
                                 </div>
